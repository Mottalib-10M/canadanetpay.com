/**
 * Canadian Provincial / Territorial Tax Data for 2025
 * Sources: CRA, Revenu Québec, individual provincial finance ministries
 */
...
export const PROVINCES: Record<string, ProvinceConfig> = {
  ...
  ON: {
    ...
    surtax: { threshold1: 4991, rate1: 0.20, threshold2: 6387, rate2: 0.36 },
    healthPremium: true,
  ...
  PE: {
    ...
    surtax: { threshold1: 12500, rate1: 0.10, threshold2: 12500, rate2: 0 },
  },
  QC: {
    name: 'Quebec',
    abbreviation: 'QC',
