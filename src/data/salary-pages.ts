...
export const SALARY_PAGES: SalaryPageConfig[] = amounts.map((amount) => {
  ...
  return {
    ...
    metaTitle: `$${formatted} Salary After Tax in Canada 2025 — Take-Home Pay`,
    metaDescription: `Calculate your take-home pay on a $${formatted} salary in Canada for 2025. See your federal tax, CPP, EI, and provincial tax breakdown across all provinces.`,
    h1: `$${formatted} Salary After Tax in Canada (2025)`,
  };
});
